...
```
10. What is the average rental duration per film category?
```SQL
...
13. Show monthly rental revenue trends for 2005 to 2006.
```SQL
...
```
22. Detect churned customers: no rentals in the past 6 months but at least 5 rentals before that.
```SQL
